...
function initQRGenerator() {
    try {
        ...
        console.warn('⚠️ QR Generator initialization error:', error.message);
    }
}
...
function initLandConverter() {
    try {
        ...
        window.landConverter = new LandConverter();
        console.log('✅ Land Converter initialized');
    } catch (error) {
        console.warn('⚠️ Land Converter initialization error:', error.message);
    }
}
...
function initDPResizer() {
    try {
        ...
        window.dpResizer = new DPResizer();
        console.log('✅ DP Resizer initialized');
    } catch (error) {
        console.warn('⚠️ DP Resizer initialization error:', error.message);
    }
}
...
function initIPExtractor() {
    try {
        ...
        window.ipExtractor = new IPExtractor();
        console.log('✅ IP Extractor initialized');
    } catch (error) {
        console.warn('⚠️ IP Extractor initialization error:', error.message);
    }
}
...
function initGlobalLandUnits() {
    try {
        ...
        window.globalLandUnits = new GlobalLandUnits();
